...
**NOTE: this is reference code for linear models to use later!!
...
# telling R to look in the data folder for the abalone data file
abalone <- read_xlsx(here("data", "Abalone IMTA_growth and pH.xlsx"))

# Sonadora temperature data from Alonzo, A. 2024
# telling R to look in the data folder for the temperature file
...
ggplot(data = abalone_clean,
  ...
  # chaning the labels
  labs( x = "pH",
        y = "Change in Shell Surface Area per Day")
```
